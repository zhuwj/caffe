...
net_model1 = '/data1/hujie/work/projects/action/alexnet_model/deploy.prototxt';
net_weights1 = '/data1/hujie/work/projects/action/alexnet_model/bvlc_alexnet.caffemodel';
net1 = caffe.Net(net_model1, net_weights1, 'train');

net_model2 = net_model1;
net_weights2 =  '/data1/hujie/work/projects/action/alexnet_model/bvlc_alexnet_flow.caffemodel';
